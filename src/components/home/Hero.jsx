...
const Hero = () => {
  ...
  <h2 className="text-4xl font-medieum sm:text-5xl  mb-6 leading-tight">
  Real Interviews Real Stories.
</h2>
<p className="text-xl font-light md:text-2xl mt-6 text-gray-100 mb-6 ">
