...
const Blog = () => {
  ...
  return (
    <div>
      ...
      <ul className="grid grid-cols-1 xl:grid-cols-3 gap-y-10 gap-x-6 items-start px-8 py-[10vh]">
        {posts.map((post) => (
          <li
            key={post.id}
          ...
          >
            ...
            <div className="order-1 sm:ml-6 xl:ml-0">
              {post.category && (
                <span className="mb-1 block text-sm font-semibold text-cyan-500">
                  {post.category}
                </span>
              )}
              ...
              <button className="group inline-flex items-center h-9 rounded-full text-sm font-semibold whitespace-nowrap px-3 focus:outline-none focus:ring-2 bg-slate-100 text-slate-700 hover:bg-slate-200 hover:text-slate-900 focus:ring-slate-500 mt-6">
                Read more
                <svg
        ...
        <li className="relative flex flex-col sm:flex-row xl:flex-col items-start">
          <div className="order-1 sm:ml-6 xl:ml-0">
            <h3 className="mb-1 text-slate-900 font-semibold">
              <span className="mb-1 block text-sm leading-6 text-cyan-500">Unexpected Questions</span>
            ...
            <a className="group inline-flex items-center h-9 rounded-full text-sm font-semibold whitespace-nowrap px-3 focus:outline-none focus:ring-2 bg-slate-100 text-slate-700 hover:bg-slate-200 hover:text-slate-900 focus:ring-slate-500 mt-6" href="">
              Read more<span className="sr-only">, Interview challenge experience</span>
          ...
          <img src="https://images.unsplash.com/photo-1605379399642-870262d3d051" alt="Interview question" className="h-[33vh] object-cover mb-6 shadow-md rounded-lg bg-slate-50 w-full sm:w-[17rem] sm:mb-0 xl:mb-6 xl:w-full" />
        </li>
        ...
        <li className="relative flex flex-col sm:flex-row xl:flex-col items-start">
          <div className="order-1 sm:ml-6 xl:ml-0">
            <h3 className="mb-1 text-slate-900 font-semibold">
              <span className="mb-1 block text-sm leading-6 text-cyan-500">When Passion Wins</span>
            ...
            <a className="group inline-flex items-center h-9 rounded-full text-sm font-semibold whitespace-nowrap px-3 focus:outline-none focus:ring-2 bg-slate-100 text-slate-700 hover:bg-slate-200 hover:text-slate-900 focus:ring-slate-500 mt-6" href="">
              Read more<span className="sr-only">, Passion in interview</span>
              <svg className="overflow-visible ml-3 text-slate-300 group-hover:text-slate-400" width="3" height="6" viewBox="0 0 3 6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M0 0L3 3L0 6" />
              </svg>
            </a>
